  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <input type="text" name="referredName" placeholder="Referred Person's Name" onChange={handleChange} required />
        <input type="email" name="referredEmail" placeholder="Referred Person's Email" onChange={handleChange} required />
